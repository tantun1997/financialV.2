...
class PRepair extends Controller
{
...
// ดึงข้อมูลอื่นๆ ที่จำเป็น
        $E_TYPE = DB::table('E_TYPE')->where('TYPE_NUMBER', 2)->get();
        ...
        return view('repairs.index', compact('E_PLAN', 'E_TYPE', 'E_BUDGET', 'E_USAGE_STATUS', 'E_CLOSE_PLAN'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('repairs.show', compact('E_PLAN', 'EQUIP_LIST', 'EQUIP_STATUS', 'E_STATUS', 'E_TYPE', 'E_BUDGET', 'E_USAGE_STATUS', 'VW_EQUIPMENT'));
    }
