...
class PReplacement extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $E_TYPE = DB::table('E_TYPE')->where('TYPE_NUMBER', 6)->get();
        ...
        return view('replacements.index', compact('E_PLAN', 'E_TYPE', 'E_BUDGET', 'E_USAGE_STATUS', 'E_CLOSE_PLAN'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('replacements.show', compact('E_PLAN', 'EQUIP_LIST', 'EQUIP_STATUS', 'E_STATUS', 'E_TYPE', 'E_BUDGET', 'E_USAGE_STATUS', 'VW_EQUIPMENT'));
    }

    public function edit(string $id)
    {
        return view('replacements.edit');
    }
