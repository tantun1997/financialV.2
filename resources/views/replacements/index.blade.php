    ...
    @section('contents')
       ...
       <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <hr />
          <a href="{{ route('export.data', ['type' => 'replacements']) }}" class="btn btn-success mb-2">Export to
             Excel</a>
       </div>
                   ...
                   <tr>
                      ...
                      <td class="text-center align-middle">
                         <div class="btn-group" role="group">
                            ...
                            <form action="{{ route('replacements.destroy', $item->PLAN_ID) }}" method="POST" onsubmit="return confirm('Delete?')" class="p-0">
                               @csrf
                               @method('DELETE')
